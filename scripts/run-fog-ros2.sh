...
echo "Start Comminication_link"
communication_link -device_id ${drone_device_id} -private_key /enclave/rsa_private.pem >${logs_dir}/comm_link_out.log 2>${logs_dir}/comm_link_err.log
